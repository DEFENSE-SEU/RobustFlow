...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Review the final solution to ensure it aligns with the question context
        review = await self.custom(input=f"Review the answer: {final_solution['response']} for the question: {problem}", instruction="")
