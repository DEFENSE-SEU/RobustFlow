...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Generate a follow-up question to clarify user intent
        follow_up_question = await self.custom(input=problem, instruction="Generate a follow-up question to clarify the user's intent.")
