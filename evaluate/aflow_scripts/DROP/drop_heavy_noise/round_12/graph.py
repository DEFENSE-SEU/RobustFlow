...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        clarifying_question = await self.custom(input=problem, instruction="What additional information do I need to answer this question?")
        responses.append(clarifying_question['response'])
