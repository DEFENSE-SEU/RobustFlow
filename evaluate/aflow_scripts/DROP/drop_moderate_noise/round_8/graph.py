...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Check for consistency in the final solution
        consistency_check = await self.custom(input=final_solution['response'], instruction="Verify the consistency of this solution.")
        
        return consistency_check['response'], self.llm.get_usage_summary()["total_cost"]
