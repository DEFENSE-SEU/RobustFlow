...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Review step to evaluate solutions before ensemble
        reviewed_solutions = await self.custom(input="Evaluate these solutions: " + ", ".join(solutions), instruction="Select the best solution based on quality.")
