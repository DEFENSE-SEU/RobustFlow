...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Review the ensemble response for final output
        reviewed_response = await self.review(input=ensemble_response['response'])
        
        # Final output from reviewed response
        final_response = reviewed_response['reviewed_response']
