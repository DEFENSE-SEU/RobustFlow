...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Review step to ensure coherence and relevance
        review = await self.custom(input=problem + final_solution['response'], instruction="Review the answer for coherence and relevance.")
