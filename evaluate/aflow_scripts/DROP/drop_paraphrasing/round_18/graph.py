...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Generate additional answers using different prompts
        additional_solution = await self.custom(input=problem, instruction=prompt_custom.ADDITIONAL_PROMPT)
        ensemble_solutions.append(additional_solution['response'])
