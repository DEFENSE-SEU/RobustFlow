...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        clarifying_questions = await self.custom(input=problem, instruction="Generate clarifying questions for better understanding.")
        
        # Generate a step-by-step thought process
        thought_process = await self.answer_generate(input=problem + clarifying_questions['response'])
