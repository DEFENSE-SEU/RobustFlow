...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        """
        # Generate a summary of the problem for better context
        problem_summary = await self.custom(input=problem, instruction="Summarize the problem.")
        
        # Generate a step-by-step breakdown of the solution
        step_by_step = await self.answer_generate(input=problem_summary['response'])
